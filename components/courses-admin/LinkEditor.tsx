...
import type { CourseItem, CourseLink } from "@/lib/api/courses.types";
...
export function LinkEditor({
  ...
  async function save(fields: Partial<Pick<CourseLink, "url" | "label" | "description">>) {
    const next: CourseLink = {
    ...
    <div className="space-y-3">
      ...
      <div>
        ...
        <input
          ...
          placeholder="Falls back to the item title if left blank"
          className="w-full rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 px-3 py-2 text-sm text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-[#2D6A4F] dark:focus:ring-[#52b788]"
        />
      </div>
      <div>
